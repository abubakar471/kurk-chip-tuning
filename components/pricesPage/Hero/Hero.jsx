        ...
        <div data-aos="fade-up" className='min-h-[45vh] relative'>
            <div className='w-[80%] mx-auto mt-40 md:mt-32'>
                <div className='w-full flex flex-col items-center justify-center'>
                    <h1 className='text-[#FDFFFF] text-6xl md:text-8xl text-center'>Our Prices</h1>
                    <p className='mt-4 text-[#FDFFFF] text-xl'>Home / <span className='underline'>Prices</span></p>
                </div>
            </div>
